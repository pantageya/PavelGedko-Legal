...
For Expense Tracker, the App is intended to help you record and review personal budget information, including transactions, accounts, categories, budgets, recurring payments, debts, savings goals, reminders, reports, backups, and subscription-protected features. Expense Tracker is a personal finance organization tool and does not provide financial, investment, tax, accounting, legal, or other regulated professional advice.
...
For Expense Tracker, User Content may include financial entries, amounts, currencies, dates, categories, payment method or account labels, notes, recurring transaction details, debts, budgets, savings goals, reminder settings, exported CSV files, PDF reports, and backup files. You are responsible for the accuracy of the information you enter and for reviewing exported files before sharing them outside the App.
...
If Expense Tracker uses iCloud or CloudKit sync, that sync is provided through Apple platform services and may depend on your Apple Account, iCloud settings, device connectivity, storage availability, and Apple's service availability. Deleting records in the App or changing iCloud settings may affect local and synced copies of your data.
...
For Expense Tracker, device features may include local notifications for reminders, secure storage for app lock data, biometric authentication where enabled by you, temporary local files for exports, and iCloud/CloudKit sync through Apple platform services. Expense Tracker's current budgeting features do not require camera, microphone, photo library, contacts, or location access.
